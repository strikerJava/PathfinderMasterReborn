...
public class FragmentFighterMake extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        //Inflate the layout for this fragment
         ...
         spawnFighter = (Button) returningView.findViewById(R.id.spawnFighterButton);
         levelUpFighter = (Button) returningView.findViewById(R.id.levelUpFighterButton);
        spawnFighter.setOnClickListener(this);
        levelUpFighter.setOnClickListener(this);
        levelUpFighter.setEnabled(false);
    ...
    public void onClick(View view){
        switch(view.getId()){
            case R.id.spawnFighterButton:
                spawnFighter();
                levelUpFighter.setEnabled(true);
                break;
